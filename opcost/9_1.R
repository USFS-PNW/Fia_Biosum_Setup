                                                                           ...
                                                                           ifelse((m$"Harvesting.System")=="Ground-Based Manual Log", sawSkidLogEst(m,m3),
                                                                                  ifelse((m$"Harvesting.System")=="Helicopter Manual WT", heliSawEst(m,m3),
                                                                                         ifelse((m$"Harvesting.System")=="Cable CTL", yarderHarEst(m,m3),
                                                                                              ifelse((m$"Harvesting.System")=="Shovel Logging", shovelEst(m,m3),
                                                                                                     ifelse((m$"Harvesting.System")=="Tethered Harvester", tetheredEst(m), 1))))))))))))
                                 }
...
tinSkid=function(m){
  sqrt(3.3*(7.3+m$"One.way.Yarding.Distance"))
}
...
tetheredEst<-function(m){
  (ifelse(totalVol(m)==0,((1.43*(mechBC(m)*.901)+(132.75))/60*278.95),((1.43*(twitchVol(m)*.901)+
                                                                          (132.75))/60*278.95)+((0.05*(2*m$"One.way.Yarding.Distance")+
                                                                                                                          4.06*(.03*twitchVol(m))+2.19*twitchVol(m))/60*198.11)))
}
                                                   ...
                                                   ifelse((m$"Harvesting.System")=="Ground-Based Manual Log", "Ground-Based Manual Log", 
                                                          ifelse((m$"Harvesting.System")=="Helicopter Manual WT", "Helicopter Manual WT", 
                                                                 ifelse((m$"Harvesting.System")=="Cable CTL", "Cable CTL",
                                                                        ifelse((m$"Harvesting.System")=="Shovel Logging", "Shovel Logging",  
                                                                               ifelse((m$"Harvesting.System")=="Tethered Harvester","Tethered",1))))))))))))
}
...
miclb<-function(m){ifelse(m$"Harvesting.System"=="Cable Manual WT"|
                            ...
                            m$"Harvesting.System"=="Ground-Based Manual Log"|
                            m$"Harvesting.System"=="Helicopter Manual WT"|
                            m$"Harvesting.System"=="Tethered Harvester"|
